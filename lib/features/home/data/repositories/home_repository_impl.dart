...
class HomeRepositoryImpl implements HomeRepository {
  ...
  Future<Either<Failure, bool>> isHistoryEnabled() async {
    try {
      ...
      return const Left(Failure("Impossible de lire l'état de l'historique."));
    }
  }
  ...
  Future<Either<Failure, Unit>> enableHistory() async {
    try {
      ...
      return const Left(Failure("Impossible d'activer l'historique."));
    }
  }

  @override
  Future<Either<Failure, List<HomePractitioner>>> getRecentPractitioners() async {
