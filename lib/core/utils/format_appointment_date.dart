...
/// Formate une date de rendez-vous en format court pour les chips (ex. "19 fév", "Aujourd'hui").
String formatAppointmentDateShort(BuildContext context, String dateLabel) {
  ...
  if (dateOnly == todayOnly) return l10n.searchFilterDateToday;
  if (dateOnly == tomorrowOnly) return l10n.searchFilterDateTomorrow;

  return DateFormat('d MMM', locale).format(dateOnly);
}
